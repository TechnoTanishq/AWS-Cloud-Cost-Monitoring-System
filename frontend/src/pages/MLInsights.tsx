...
import { mlInsights, anomalies } from "@/data/mockData";
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="card-elevated p-5">
            ...
            <p className="text-2xl font-bold">${mlInsights.predictedCost.toLocaleString()}</p>
          ...
          <div className="card-elevated p-5">
            ...
            <p className="text-2xl font-bold">+{mlInsights.trendPercentage}%</p>
        ...
        <div className="card-elevated p-5 border-l-4 border-l-primary">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">{mlInsights.explanation}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card-elevated p-5">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <ComposedChart data={mlInsights.forecast}>
          ...
          <div className="space-y-4">
            {mlInsights.topDrivers.map((d) => (
              <div key={d.service} className="flex items-center gap-4">
                ...
                <span className="text-xs font-medium text-primary">+{d.change}%</span>
              </div>
            ))}
          </div>
        </div>
